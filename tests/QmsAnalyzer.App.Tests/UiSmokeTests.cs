...
using QmsAnalyzer.App;
using QmsAnalyzer.App.Tests;
...
namespace QmsAnalyzer.App.Tests;
...
public class UiSmokeTests
{
    ...
    public void AllSections_RenderWithoutBindingCrash()
    {
        ...
        foreach (var section in new[] { "library", "graph", "drill", "trace", "dashboard", "settings" })
        {
            vm.Section = section;
            Dispatcher.UIThread.RunJobs();
