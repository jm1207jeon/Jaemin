...
/// <summary>%AppData%/QmsWeaver/config.json 로드·저장. API 키는 이 로컬 파일에만 존재한다.</summary>
public sealed class ConfigService
{
    ...
    public ConfigService(string? baseDir = null)
    {
        ConfigDir = baseDir ?? Path.Combine(
            Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "QmsWeaver");
